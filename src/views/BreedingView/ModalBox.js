...
const ModalBox = ({ children, close, onClose }) => {
...
console.log(close)
    ...
    return (
      <div className={closed ? "aali_tm_modalbox" : "aali_tm_modalbox opened"}>
        <div className="box_inner">
          ...
          <button className="button" onClick={() => {setClosed(true)}}>Save</button>
        </div>
      </div>
    );
  };
