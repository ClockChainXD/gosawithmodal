...
export const stickyNav = () => {
  ...
  const stickys = document.querySelectorAll(".gosaa_tm_header");
...
// Moveing effect
export const gosaa_tm_moving_animation = () => {
...
export const scroll_ = () => {
  const sections = document.querySelectorAll(".gosaa_tm_section");
